      ...
      <Card.Body>
        <HStack align="start" gap={4}>
          ...
          <VStack align="start" flex={1} gap={2}>
            ...
            {student.course_name && (
              <Text fontSize="sm">
                <Text as="span" fontWeight="medium">Course:</Text> {student.course_name}
              </Text>
            )}
            
            {student.specialization && (
              <Text fontSize="sm">
                <Text as="span" fontWeight="medium">Specialization:</Text>{' '}
            ...
            {student.course_progression && (
              <Text fontSize="sm">
                <Text as="span" fontWeight="medium">Progress:</Text> {student.course_progression}
              </Text>
            )}
          </VStack>
        </HStack>
