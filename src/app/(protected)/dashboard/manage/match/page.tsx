...
import { Box, VStack, Heading, Input, Button, Text, useDisclosure, Spinner, HStack, Avatar, SimpleGrid, Container, Image } from "@chakra-ui/react"
...
const Match = () => {
  ...
  const { data, isLoading, error } = useParticipants(opportunityId || "", filters)
            ...
            <Box w="100%">
              ...
              >
                {data?.results?.map((org: Participant) => (
                  <HStack key={org.id} borderRadius="12px" border="1px solid #2CA9DF" gap={{ base: 4, lg: 6 }} px={{ base: 4, lg: 10 }} height={{ base: "80px", lg: "115px" }} overflowX="auto" onClick={() => handleSelect(org)}>
                <Box w={{base: "50px", lg: "75px"}} h={{base: "50px", lg: "75px"}} borderRadius="50%" border="5px solid #22C45E"
                display="flex"
                alignItems="center"
              ...
              >
                ...
                {org.image_url && (
                  ...
                  />
                    ...
                    <Text fontSize={{ base: "18px", lg: "28px" }} fontWeight="600" color="#000000">{org.name}</Text>
                  </HStack>
                ))}
              </SimpleGrid>
            </Box>
          ...
          >
            <VStack align="stretch" gap={6}>
              ...
              <Text fontSize="16px" color="#666666">
                Are you sure you want to match this student to <b>{selectedOrg?.name}</b>?
              </Text>
