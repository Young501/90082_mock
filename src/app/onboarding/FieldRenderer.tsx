...
export const FieldRenderer = ({
  ...
  const renderField = () => {
    ...
    if (question.type === 'file') {
      const fileType = FILE_FIELD_TYPES[question.field as keyof typeof FILE_FIELD_TYPES]
      if (!fileType) {
        console.error(`File field '${question.field}' is not defined in FILE_FIELD_TYPES`)
        return null
      }
      return (
        <FileField
