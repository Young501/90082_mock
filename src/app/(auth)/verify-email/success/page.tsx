...
import { Box, Container, Text, Button, VStack, Icon, useBreakpointValue } from '@chakra-ui/react';
            ...
            >
                <VStack gap={{ base: 6, md: 8 }}>
                    ...
                    <Text
                        ...
                        px={{ base: 2, md: 0 }}
                    >
                        Your email has been verified. You can now log in to your account and start exploring UniConnected.
                    </Text>
